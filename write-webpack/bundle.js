(function(modules) { // webpackBootstrap 启动
  // The module cache 模块缓存
  var installedModules = {};

  // The require function 核心：require函数
